...
See [docs/keaddns.md](docs/keaddns.md) for full documentation including
configuration examples, troubleshooting, and API reference.
...
│   ├── +POST_INSTALL.post       # Post-install script (applies core patch)
│   ├── +PRE_DEINSTALL.pre       # Pre-deinstall script (reverses core patch)
│   ├── Makefile
│   ├── pkg-descr
│   └── src/
